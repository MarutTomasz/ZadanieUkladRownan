...
${OBJ}/main.o: src/main.cpp inc/Wektor.hh inc/MacierzKw.hh inc/UkladRownanL.hh inc/rozmiar.h
	g++ -c ${FLAGS} -o ${OBJ}/main.o src/main.cpp

${OBJ}/Wektor.o: src/Wektor.cpp inc/Wektor.hh inc/rozmiar.h
	g++ -c ${FLAGS} -o ${OBJ}/Wektor.o src/Wektor.cpp

${OBJ}/MacierzKw.o: src/MacierzKw.cpp inc/MacierzKw.hh  inc/Wektor.hh inc/rozmiar.h
	g++ -c ${FLAGS} -o ${OBJ}/MacierzKw.o src/MacierzKw.cpp

${OBJ}/UkladRownanL.o: src/UkladRownanL.cpp inc/MacierzKw.hh  inc/Wektor.hh inc/UkladRownanL.hh inc/rozmiar.h
